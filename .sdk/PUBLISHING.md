...
|---|---|---|
| `ts/` | @voxgig-sdk/opensensemap-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/opensensemap-sdk \
      --repository voxgig-sdk/opensensemap-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/opensensemap-sdk` shows it, and
`npm trust revoke @voxgig-sdk/opensensemap-sdk --id=<id>` removes it.
