...
// Opensensemap SDK audit feature
...
class OpensensemapAuditFeature extends OpensensemapBaseFeature
{
    ...
    private function _emit(OpensensemapContext $ctx, string $outcome): void
    {
