...
// Opensensemap SDK cache feature
...
class OpensensemapCacheFeature extends OpensensemapBaseFeature
{
    ...
    private function _through(OpensensemapContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
