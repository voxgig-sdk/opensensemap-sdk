...
// Opensensemap SDK idempotency feature
...
class OpensensemapIdempotencyFeature extends OpensensemapBaseFeature
{
    ...
    private function _mutating(OpensensemapContext $ctx): bool
    {
