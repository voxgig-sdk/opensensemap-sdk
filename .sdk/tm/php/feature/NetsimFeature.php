...
// Opensensemap SDK netsim feature
...
class OpensensemapNetsimFeature extends OpensensemapBaseFeature
{
    ...
    private function _simulate(OpensensemapContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpensensemapContext $ctx, array $applied): void
    {
        $client = $this->client;
