...
// Opensensemap SDK proxy feature
...
class OpensensemapProxyFeature extends OpensensemapBaseFeature
{
    ...
    public function init(OpensensemapContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpensensemapContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
