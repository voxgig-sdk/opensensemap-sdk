...
class OpensensemapRbacFeature extends OpensensemapBaseFeature
{
    ...
    private function _required(OpensensemapContext $ctx): ?string
    {
    ...
    private function _reject(OpensensemapContext $ctx, string $required): void
    {
    ...
    private function _track(OpensensemapContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
