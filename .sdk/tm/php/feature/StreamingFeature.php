...
// Opensensemap SDK streaming feature
...
class OpensensemapStreamingFeature extends OpensensemapBaseFeature
{
    ...
    private function _iterate(OpensensemapResult $result): \Generator
    {
    ...
    private function _streamable(OpensensemapContext $ctx): bool
    {
