...
// Opensensemap SDK telemetry feature
...
class OpensensemapTelemetryFeature extends OpensensemapBaseFeature
{
    ...
    private function _close(OpensensemapContext $ctx, bool $ok): void
    {
