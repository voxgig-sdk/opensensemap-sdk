...
// Opensensemap SDK pipeline test
//
...
{
    private static function utility(): OpensensemapUtility
    {
        return new OpensensemapUtility();
    }
    ...
    private static function ctx(array $over = []): OpensensemapContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new OpensensemapContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new OpensensemapOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof OpensensemapError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new OpensensemapOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = OpensensemapMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new OpensensemapOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = OpensensemapMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new OpensensemapOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = OpensensemapMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OpensensemapSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = OpensensemapMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new OpensensemapResponse([]),
            'result' => new OpensensemapResult([]),
        ]);
        [, $err] = OpensensemapMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new OpensensemapSpec([]),
            'response' => null,
            'result' => new OpensensemapResult([]),
        ]);
        [, $err] = OpensensemapMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new OpensensemapSpec(['step' => 's']),
            'response' => new OpensensemapResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new OpensensemapResult([]),
        ]);
        [, $err] = OpensensemapMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new OpensensemapSpec(['step' => 's']),
            'response' => new OpensensemapResponse(self::resp(200, ['v' => 1])),
            'result' => new OpensensemapResult([]),
        ]);
        [, $err] = OpensensemapMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new OpensensemapSpec(['step' => 's']),
            'response' => new OpensensemapResponse(self::resp(200, ['v' => 2])),
            'result' => new OpensensemapResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        OpensensemapMakeResponse::call($ctx);
    ...
    {
        $preset = new OpensensemapResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new OpensensemapSpec([]),
            'response' => new OpensensemapResponse([]),
            'result' => new OpensensemapResult([]),
        ...
        [$got, $err] = OpensensemapMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new OpensensemapResult([])]);
        [, $err] = OpensensemapMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new OpensensemapSpec([]), 'result' => null]);
        [, $err] = OpensensemapMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OpensensemapSpec(['step' => 's']),
            'result' => new OpensensemapResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new OpensensemapOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OpensensemapMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new OpensensemapSpec(['step' => 's']),
            'result' => new OpensensemapResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new OpensensemapOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = OpensensemapMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new OpensensemapResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new OpensensemapSpec([]),
            'result' => new OpensensemapResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = OpensensemapMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OpensensemapMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new OpensensemapError('boom', 'boom');
        $utility->fetcher = function (OpensensemapContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OpensensemapSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = OpensensemapMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (OpensensemapContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = OpensensemapMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(OpensensemapResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        OpensensemapMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (OpensensemapContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new OpensensemapSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = OpensensemapMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new OpensensemapResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new OpensensemapSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = OpensensemapMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = OpensensemapMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = OpensensemapMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new OpensensemapResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, OpensensemapDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new OpensensemapResult(['ok' => false])]);
        $this->expectException(OpensensemapError::class);
        OpensensemapDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new OpensensemapResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', OpensensemapMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        OpensensemapMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new OpensensemapBaseFeature();
        $b = new OpensensemapBaseFeature();
        OpensensemapFeatureAdd::call($ctx, $a);
        OpensensemapFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): OpensensemapBaseFeature
    {
        $f = new OpensensemapBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        OpensensemapFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): OpensensemapContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new OpensensemapSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = OpensensemapPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        OpensensemapPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new OpensensemapResponse(['headers' => null]),
            'result' => new OpensensemapResult([]),
        ]);
        OpensensemapResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        OpensensemapResultBody::call($ctx);
