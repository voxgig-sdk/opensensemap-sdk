...
// Opensensemap SDK utility: fetcher

class OpensensemapFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpensensemapSDK/1.0)';
    ...
    public static function call(OpensensemapContext $ctx, string $fullurl, array $fetchdef): array
    {
