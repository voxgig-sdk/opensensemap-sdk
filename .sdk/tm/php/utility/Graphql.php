...
// Opensensemap SDK utility: graphql
//
...
class OpensensemapGraphql
{
    ...
    // equivalent.
    public static function body(OpensensemapContext $ctx): mixed
    {
    ...
    public static function errors(OpensensemapContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
