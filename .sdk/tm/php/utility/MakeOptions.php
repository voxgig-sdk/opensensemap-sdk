...
// Opensensemap SDK utility: make_options

class OpensensemapMakeOptions
{
    ...
    public static function call(OpensensemapContext $ctx): array
    {
        ...
        //
        // `OpensensemapSchema::optspec()` is built from the model:
        ...
        $optspec = OpensensemapSchema::optspec();
