...
// Opensensemap SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OpensensemapTransformResponse
{
    public static function call(OpensensemapContext $ctx): mixed
    {
        ...
        $transform = OpensensemapHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
