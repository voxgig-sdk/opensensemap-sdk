...
from projectname_sdk.core.control import OpensensemapControl
...
class OpensensemapContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, OpensensemapSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OpensensemapResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OpensensemapResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OpensensemapError(code, msg, self)
