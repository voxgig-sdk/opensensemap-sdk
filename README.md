...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/opensensemap` | `npm install @voxgig-sdk/opensensemap` |
| Python | `voxgig-sdk-opensensemap` | `pip install voxgig-sdk-opensensemap` |
| PHP | `voxgig-sdk/opensensemap` | `composer require voxgig-sdk/opensensemap` |
| Golang | `github.com/voxgig-sdk/opensensemap-sdk/go` | `go get github.com/voxgig-sdk/opensensemap-sdk/go` |
| Ruby | `voxgig-sdk-opensensemap` | `gem install voxgig-sdk-opensensemap` |
| Lua | `voxgig-sdk-opensensemap` | `luarocks install voxgig-sdk-opensensemap` |
