...
func registerSDKWords(r *eng.Registry, client *sdk.OpensensemapSDK) {
...
func runOp(client *sdk.OpensensemapSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
