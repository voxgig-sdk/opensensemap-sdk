...
func registerTools(server *mcp.Server, client *sdk.OpensensemapSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "opensensemap_list",
		Description: "List records from Opensensemap. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "opensensemap_load",
		Description: "Load a single record from Opensensemap. " +
...
func runOp(client *sdk.OpensensemapSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpensensemapSDK, name string) (sdk.OpensensemapEntity, error) {
	...
	case "statistic":
		return client.Statistic(nil), nil
	case "user":
