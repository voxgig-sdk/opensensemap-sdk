...
The Golang SDK for the Opensensemap API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/opensensemap-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/opensensemap-sdk=../path/to/github.com/voxgig-sdk/opensensemap-sdk
```
...
```
github.com/voxgig-sdk/opensensemap-sdk/
...
The root package (`github.com/voxgig-sdk/opensensemap-sdk`) re-exports everything needed
