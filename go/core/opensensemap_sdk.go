...
func (sdk *OpensensemapSDK) OptionsMap() map[string]any {
...
func (sdk *OpensensemapSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpensensemapSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpensensemapSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpensensemapSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
// gate by passing it.
func (sdk *OpensensemapSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpensensemapSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpensensemapSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OpensensemapSDK {
	...
	sdk := NewOpensensemapSDK(sdkopts)
	sdk.Mode = "test"
