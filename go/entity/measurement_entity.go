...
func NewMeasurementEntity(client *core.OpensensemapSDK, entopts map[string]any) *MeasurementEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MeasurementEntity) GetName() string { return e.name }
...
func (e *MeasurementEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MeasurementEntity) Deleted() bool {
	return e.deleted
}


func (e *MeasurementEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMeasurementEntity(e.client, opts)
}

func (e *MeasurementEntity) Data(args ...any) any {
...
func (e *MeasurementEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Measurement; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MeasurementEntity) DataTyped(data ...Measurement) Measurement {
	if len(data) > 0 {
		return typedFrom[Measurement](e.Data(asMap(data[0])))
	}
	return typedFrom[Measurement](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Measurement (all fields
// optional at the wire level).
func (e *MeasurementEntity) MatchTyped(match ...Measurement) Measurement {
	if len(match) > 0 {
		return typedFrom[Measurement](e.Match(asMap(match[0])))
	}
	return typedFrom[Measurement](e.Match())
}
...
func (e *MeasurementEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MeasurementEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *MeasurementEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *MeasurementEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MeasurementCreateData and returns an Measurement. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MeasurementEntity) CreateTyped(reqdata MeasurementCreateData, ctrl map[string]any) (Measurement, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Measurement{}, err
	}
	return typedFrom[Measurement](res), nil
}



func (e *MeasurementEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MeasurementEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MeasurementEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
