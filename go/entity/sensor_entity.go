...
func NewSensorEntity(client *core.OpensensemapSDK, entopts map[string]any) *SensorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SensorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SensorEntity) Deleted() bool {
	return e.deleted
}


func (e *SensorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSensorEntity(e.client, opts)
}

func (e *SensorEntity) Data(args ...any) any {
...
func (e *SensorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Sensor; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SensorEntity) DataTyped(data ...Sensor) Sensor {
	if len(data) > 0 {
		return typedFrom[Sensor](e.Data(asMap(data[0])))
	}
	return typedFrom[Sensor](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Sensor (all fields
// optional at the wire level).
func (e *SensorEntity) MatchTyped(match ...Sensor) Sensor {
	if len(match) > 0 {
		return typedFrom[Sensor](e.Match(asMap(match[0])))
	}
	return typedFrom[Sensor](e.Match())
}
...
func (e *SensorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SensorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SensorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SensorListMatch and returns []Sensor. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SensorEntity) ListTyped(reqmatch SensorListMatch, ctrl map[string]any) ([]Sensor, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Sensor](res), nil
}



func (e *SensorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SensorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SensorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SensorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
