...
func NewStatisticEntity(client *core.OpensensemapSDK, entopts map[string]any) *StatisticEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StatisticEntity) GetName() string { return e.name }
...
func (e *StatisticEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StatisticEntity) Deleted() bool {
	return e.deleted
}


func (e *StatisticEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStatisticEntity(e.client, opts)
}

func (e *StatisticEntity) Data(args ...any) any {
...
func (e *StatisticEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Statistic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StatisticEntity) DataTyped(data ...Statistic) Statistic {
	if len(data) > 0 {
		return typedFrom[Statistic](e.Data(asMap(data[0])))
	}
	return typedFrom[Statistic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Statistic (all fields
// optional at the wire level).
func (e *StatisticEntity) MatchTyped(match ...Statistic) Statistic {
	if len(match) > 0 {
		return typedFrom[Statistic](e.Match(asMap(match[0])))
	}
	return typedFrom[Statistic](e.Match())
}
...
func (e *StatisticEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StatisticEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StatisticLoadMatch and returns an Statistic. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StatisticEntity) LoadTyped(reqmatch StatisticLoadMatch, ctrl map[string]any) (Statistic, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Statistic{}, err
	}
	return typedFrom[Statistic](res), nil
}



func (e *StatisticEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *StatisticEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StatisticEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StatisticEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StatisticEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
