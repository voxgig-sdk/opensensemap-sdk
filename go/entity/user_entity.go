...
func NewUserEntity(client *core.OpensensemapSDK, entopts map[string]any) *UserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
