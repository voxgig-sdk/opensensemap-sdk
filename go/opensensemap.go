...
// instead of `sdk.NewOpensensemapSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *OpensensemapSDK  { return NewOpensensemapSDK(nil) }
func Test() *OpensensemapSDK { return TestSDK(nil, nil) }
