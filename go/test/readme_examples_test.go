...
const testSeed = `map[string]any{"entity": map[string]any{"box": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "measurement": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sensor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "statistic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
