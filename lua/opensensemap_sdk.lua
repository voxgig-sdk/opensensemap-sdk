...
local OpensensemapSDK = {}
OpensensemapSDK.__index = OpensensemapSDK
...
OpensensemapSDK._make_feature = _make_feature


function OpensensemapSDK.new(options)
  local self = setmetatable({}, OpensensemapSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function OpensensemapSDK:options_map()
...
function OpensensemapSDK:get_utility()
  return Utility.copy(self._utility)
end


function OpensensemapSDK:get_root_ctx()
  return self._rootctx
end


function OpensensemapSDK:prepare(fetchargs)
...
function OpensensemapSDK:direct(fetchargs)
...
-- by passing it.
function OpensensemapSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function OpensensemapSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "OpensensemapSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function OpensensemapSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = OpensensemapSDK.new(sdkopts)
  sdk.mode = "test"
