...
local SDK_MODULE = "opensensemap_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["box"] = { ["test01"] = { id = "test01" } }, ["measurement"] = { ["test01"] = { id = "test01" } }, ["sensor"] = { ["test01"] = { id = "test01" } }, ["statistic"] = { ["test01"] = { id = "test01" } }, ["user"] = { ["test01"] = { id = "test01" } } } }'
