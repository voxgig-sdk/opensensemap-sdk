...
function runner.env_override(m)
  local live = runner.getenv("OPENSENSEMAP_TEST_LIVE")
  local override = runner.getenv("OPENSENSEMAP_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENSENSEMAP_TEST_EXPLAIN")
