...
describe("StatisticDirect", function()
  it("should direct-load-statistic", function()
    local setup = statistic_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-statistic", setup.live and "live" or "unit")
...
function statistic_direct_setup(mockres)
