...
// Opensensemap SDK utility type

class OpensensemapUtility
{
    ...
    public static function copy(OpensensemapUtility $src): OpensensemapUtility
    {
        $u = new OpensensemapUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
