...
class MeasurementEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MeasurementEntity($this->_client, $opts);
    }

    /**
     * @param Measurement|array $args Measurement data (assoc-array) to store.
     */
    ...
    /**
     * @return Measurement|array The current Measurement data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Measurement fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Measurement fields).
     */
     ...
     *
     * @param MeasurementCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MeasurementCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Measurement|array The created Measurement as an assoc-array at the
