...
// Opensensemap SDK Sensor entity
...
class SensorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SensorEntity($this->_client, $opts);
    }

    /**
     * @param Sensor|array $args Sensor data (assoc-array) to store.
     */
    ...
    /**
     * @return Sensor|array The current Sensor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sensor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sensor fields).
     */
    ...
    /**
     * List Sensor items matching the given filter.
     *
     * @param SensorListMatch|array|null $reqmatch Match filter (any subset
     *   of Sensor fields) as an assoc-array; SensorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sensor[]|array A list of Sensor items as assoc-arrays at
