...
class StatisticEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StatisticEntity($this->_client, $opts);
    }

    /**
     * @param Statistic|array $args Statistic data (assoc-array) to store.
     */
    ...
    /**
     * @return Statistic|array The current Statistic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Statistic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Statistic fields).
     */
    ...
    /**
     * Load a single Statistic.
     *
     * @param StatisticLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StatisticLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Statistic|array The loaded Statistic as an assoc-array at the
