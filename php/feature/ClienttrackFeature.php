...
// Opensensemap SDK clienttrack feature
...
class OpensensemapClienttrackFeature extends OpensensemapBaseFeature
{
    ...
    public function PostConstruct(OpensensemapContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Opensensemap-SDK';
