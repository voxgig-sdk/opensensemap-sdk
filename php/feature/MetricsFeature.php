...
// Opensensemap SDK metrics feature
...
class OpensensemapMetricsFeature extends OpensensemapBaseFeature
{
    ...
    private function _record(OpensensemapContext $ctx, bool $ok): void
    {
