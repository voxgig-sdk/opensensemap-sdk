...
// Opensensemap SDK ratelimit feature
...
class OpensensemapRatelimitFeature extends OpensensemapBaseFeature
{
    ...
    private function _acquire(OpensensemapContext $ctx): void
    {
    ...
    private function _track(OpensensemapContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
