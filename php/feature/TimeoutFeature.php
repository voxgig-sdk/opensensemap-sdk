...
// Opensensemap SDK timeout feature
...
class OpensensemapTimeoutFeature extends OpensensemapBaseFeature
{
    ...
    private function _with_timeout(OpensensemapContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpensensemapContext $_ctx, float $ms): void
    {
        $client = $this->client;
