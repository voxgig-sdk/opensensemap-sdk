...
// Opensensemap SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpensensemapSDK::test)
...
{
    private const SDK_CLASS = 'OpensensemapSDK';
    ...
    private const SDK_BASE = 'opensensemap_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../opensensemap_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
