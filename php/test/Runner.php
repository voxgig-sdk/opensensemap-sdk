...
class OpensensemapTestRunner
{
    ...
    {
        $live = self::getenv('OPENSENSEMAP_TEST_LIVE');
        $override = self::getenv('OPENSENSEMAP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('OPENSENSEMAP_TEST_EXPLAIN');
...
class_alias('OpensensemapTestRunner', 'Runner');
class_alias('OpensensemapHelpers', 'Helpers');
