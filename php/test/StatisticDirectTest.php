...
class StatisticDirectTest extends TestCase
{
    public function test_direct_load_statistic(): void
    {
        $setup = statistic_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-statistic", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
