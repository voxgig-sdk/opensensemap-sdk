...
// Opensensemap SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OpensensemapOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OpensensemapOmni::structfix($now, Struct::undef()))
                        !== json_encode(OpensensemapOmni::structfix($val, Struct::undef()))) {
