...
// Opensensemap SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpensensemapMakeRequest
{
    public static function call(OpensensemapContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpensensemapResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpensensemapResponse($fetched);
        } else {
