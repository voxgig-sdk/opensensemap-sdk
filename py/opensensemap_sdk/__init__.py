...
from opensensemap_sdk.utility import register

# Load features
from opensensemap_sdk.feature.base_feature import OpensensemapBaseFeature
from opensensemap_sdk.features import _has_feature, _make_feature
...
class OpensensemapSDK:
    ...
    def get_utility(self):
        return OpensensemapUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpensensemapSDK: graphql: " + str(msg))
            res["graphql"] = errors
