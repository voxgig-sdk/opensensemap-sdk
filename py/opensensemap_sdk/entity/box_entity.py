...
class BoxEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BoxEntity(self._client, opts)
    ...
    def create(self, reqdata: BoxCreateData, ctrl=None) -> Box:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: BoxUpdateData, ctrl=None) -> Box:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
