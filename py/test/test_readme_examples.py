# Opensensemap SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpensensemapSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpensensemapSDK(...) and OpensensemapSDK.test(...) become
#      OpensensemapSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "opensensemap_sdk"
_SDK_CLASS = "OpensensemapSDK"
