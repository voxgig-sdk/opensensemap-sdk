...
class UserEntity
  ...
  #
  # @param reqmatch [UserListMatch, Hash, nil] match filter (any subset of
  #   User fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<User>, Array] the matching User items; raises OpensensemapError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [User, Hash] the created User; raises OpensensemapError on failure
