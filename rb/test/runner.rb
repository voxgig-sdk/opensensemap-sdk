...
module OpensensemapTestRunner
  ...
  def self.env_override(m)
    live = getenv("OPENSENSEMAP_TEST_LIVE")
    override = getenv("OPENSENSEMAP_TEST_OVERRIDE")
    ...
    explain = getenv("OPENSENSEMAP_TEST_EXPLAIN")
    m["OPENSENSEMAP_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = OpensensemapTestRunner
Helpers = OpensensemapHelpers
Vs = VoxgigStruct
