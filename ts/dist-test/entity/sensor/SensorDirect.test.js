...
(0, node_test_1.describe)('SensorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-sensor', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-sensor', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["box01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENSENSEMAP_TEST_SENSOR_ENTID'];
...
//# sourceMappingURL=SensorDirect.test.js.map