...
(0, node_test_1.describe)('SensorEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/sensor/SensorTestData.json');
    ...
    let idmap = transform(['sensor01', 'sensor02', 'sensor03', 'box01', 'box02', 'box03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SensorEntity.test.js.map