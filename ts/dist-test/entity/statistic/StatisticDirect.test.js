...
(0, node_test_1.describe)('StatisticDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-statistic', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-statistic', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENSENSEMAP_TEST_STATISTIC_ENTID'];
...
//# sourceMappingURL=StatisticDirect.test.js.map