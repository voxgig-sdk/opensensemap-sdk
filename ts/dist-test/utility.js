...
function envOverride(m) {
    if ('TRUE' === process.env.OPENSENSEMAP_TEST_LIVE ||
        'TRUE' === process.env.OPENSENSEMAP_TEST_OVERRIDE) {
    ...
    m.OPENSENSEMAP_TEST_EXPLAIN = process.env.OPENSENSEMAP_TEST_EXPLAIN || m.OPENSENSEMAP_TEST_EXPLAIN;
    return m;
}
