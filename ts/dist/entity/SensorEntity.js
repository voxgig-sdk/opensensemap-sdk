...
class SensorEntity extends OpensensemapEntityBase_1.OpensensemapEntityBase {
    ...
    make() {
        return new SensorEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Sensor[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
