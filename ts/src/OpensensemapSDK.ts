...
class OpensensemapSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('OpensensemapSDK: graphql: ' +
  ...
  Box(entopts?: Record<string, any>) {
    const self = this
    return new BoxEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Sensor(entopts?: Record<string, any>) {
    const self = this
    return new SensorEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Statistic(entopts?: Record<string, any>) {
    const self = this
    return new StatisticEntity(self, entopts)
  }
