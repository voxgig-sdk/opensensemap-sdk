...
class BoxEntity extends OpensensemapEntityBase<Box> {
  ...
  make(this: BoxEntity) {
    return new BoxEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: BoxLoadMatch, ctrl?: Control): Promise<BoxEntity> {
  ...
  async list(this: any, reqmatch?: BoxListMatch, ctrl?: Control): Promise<BoxEntity[]> {
  ...
  async create(this: any, reqdata?: BoxCreateData, ctrl?: Control): Promise<BoxEntity> {
  ...
  async update(this: any, reqdata?: BoxUpdateData, ctrl?: Control): Promise<BoxEntity> {
  ...
  async remove(
    this: any, reqmatch?: BoxRemoveMatch, ctrl?: Control,
  ): Promise<BoxEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<BoxEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
